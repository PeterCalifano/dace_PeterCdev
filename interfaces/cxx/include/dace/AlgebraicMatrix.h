...
namespace DACE
{
     ...
     ************************************************************************************/
    template <typename U>
    std::ostream &operator<<(std::ostream &out, const AlgebraicMatrix<U> &obj); //!< Overload output stream operator
    template <>
    DACE_API std::ostream &operator<<(std::ostream &out, const AlgebraicMatrix<DA> &obj); //!< DA specialization of output stream operator
    template <typename U>
    std::istream &operator>>(std::istream &in, AlgebraicMatrix<U> &obj); //!< Overload input stream operator
    template <>
    DACE_API std::istream &operator>>(std::istream &in, AlgebraicMatrix<DA> &obj); //!< DA specialization of input stream operator
