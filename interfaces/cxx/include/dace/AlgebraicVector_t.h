...
namespace DACE
{
     ...
     ************************************************************************************/
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector() : std::vector<T>()
    {
    ...
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector(size_t size) : std::vector<T>(size)
    {
    ...
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector(size_t size, const T &d) : std::vector<T>(size, d)
    {
    ...
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector(const std::vector<T> &v) : std::vector<T>(v)
    {
    ...
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector(std::initializer_list<T> l) : std::vector<T>(l)
    {
    ...
    template <typename T>
    AlgebraicVector<T>::AlgebraicVector(const std::vector<T> &v, size_t first, size_t last) : std::vector<T>(v.begin() + first, v.begin() + last + 1)
    {
    ...
    AlgebraicVector<T>::AlgebraicVector(const Eigen::VectorXd &vector) : std::vector<T>(vector.size())
    {
        ...
        else if constexpr (std::is_same<T, DA>::value)
        {
            for (int i = 0; i < vector.size(); ++i)
            { // Assuming that each entry of the vector is a different DA variable
                (*this)[i] = T(i) + vector(i);
            }
        }
    };
    ...
    //template <>
    //AlgebraicVector<DA>::AlgebraicVector(const Eigen::VectorXd &vector, const std::vector<int> DAvarIndex) : std::vector<DA>(vector.size())
    //{
    //    if (!DAvarIndex.size() == vector.size())
    //    {
    //        throw std::runtime_error("Indices vector size does not match Eigen::VectorXd size!");
    //    };
    //    for (int i = 0; i < vector.size(); ++i)
    //    { // A std::vector<int> DAvarIndex is provided to map the Eigen::VectorXd to the DA variables
    //        (*this)[i] = T(DAvarIndex.at(i)) + vector(i);
    //    };
    //};
    // #endif /* WITH_EIGEN */
     ...
     ************************************************************************************/
    template <typename T>
    AlgebraicVector<double> AlgebraicVector<T>::cons() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::extract(const size_t first, const size_t last) const
    {
    ...
    template <typename T>
    template <typename V>
    AlgebraicVector<typename PromotionTrait<T, V>::returnType> AlgebraicVector<T>::concat(const std::vector<V> &obj) const
    {
     ...
     ************************************************************************************/
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::operator-() const
    {
    ...
    template <typename T>
    template <typename U>
    AlgebraicVector<T> &AlgebraicVector<T>::operator+=(const AlgebraicVector<U> &obj)
    {
    ...
    template <typename T>
    template <typename U>
    AlgebraicVector<T> &AlgebraicVector<T>::operator+=(const U &obj)
    {
    ...
    template <typename T>
    template <typename U>
    AlgebraicVector<T> &AlgebraicVector<T>::operator<<(const std::vector<U> &obj)
    {
    ...
    template <typename T>
    template <typename V>
    typename PromotionTrait<T, V>::returnType AlgebraicVector<T>::dot(const AlgebraicVector<V> &obj) const
    {
    ...
    template <typename T>
    template <typename V>
    AlgebraicVector<typename PromotionTrait<T, V>::returnType> AlgebraicVector<T>::cross(const AlgebraicVector<V> &obj) const
    {
     ...
     ************************************************************************************/
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::pow(const int p) const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::sqrt() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::exp() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::log() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::sin() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::cos() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::tan() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::asin() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::acos() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::atan() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::atan2(const AlgebraicVector<T> &obj) const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::sinh() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::cosh() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::tanh() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::logb(const double b) const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::isrt() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::sqr() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::minv() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::root(const int p) const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::asinh() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::acosh() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::atanh() const
    {
     ...
     ************************************************************************************/
    template <typename T>
    T AlgebraicVector<T>::vnorm() const
    {
         ...
         */
        using DACE::sqr; // Implementational note: these using statements are very subtle and absolutely needed.
                         // They force the compiler to perform argument dependent lookup (ADL) which then finds
                         // the correct root() and pow() functions even if they are not in DACE:: or std::! using std::sqrt;
        const size_t size = this->size();
        T norm = 0.0;
        for (size_t i = 0; i < size; i++)
        {
    ...
    template <typename T>
    AlgebraicVector<T> AlgebraicVector<T>::normalize() const
    {
    ...
    template <>
    template <typename V>
    V AlgebraicVector<DA>::eval(const V &args) const
    {
    ...
    template <>
    template <typename U>
    AlgebraicVector<U> AlgebraicVector<DA>::eval(const std::initializer_list<U> l) const
    {
    ...
    template <>
    template <typename U>
    AlgebraicVector<U> AlgebraicVector<DA>::evalScalar(const U &arg) const
    {
    ...
    std::istream &operator>>(std::istream &in, AlgebraicVector<U> &obj)
    {
        ...
        if (in.good())
        {
            ...
            if (!(std::istringstream(size_str) >> vec_size))
                vec_size = 0;
    ...
    template <typename T>
    std::string AlgebraicVector<T>::toString() const
    {
    ...
    template <typename T>
    AlgebraicVector<T> root(const AlgebraicVector<T> &obj, const int p)
    {
        /*! Compute the p-th root of a AlgebraicVector<T>.
            The result is copied in a new AlgebraicVector<T>.
           \param[in] obj AlgebraicVector<T>.
    ...
    template <typename T>
    AlgebraicVector<T> logb(const AlgebraicVector<T> &obj, const double b)
    {
        /*! Compute the logarithm of a AlgebraicVector<T> with respect to a given base.
            The result is copied in a new AlgebraicVector<T>.
           \param[in] obj AlgebraicVector<T>.
    ...
    template <typename U, typename V>
    typename PromotionTrait<U, V>::returnType dot(const AlgebraicVector<U> &obj1, const AlgebraicVector<V> &obj2)
    {
